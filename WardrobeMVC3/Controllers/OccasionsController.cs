...
namespace WardrobeMVC3.Controllers
{
    public class OccasionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccasionsID,Occasion1")] Occasion occasion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccasionsID,Occasion1")] Occasion occasion)
        {
            if (ModelState.IsValid)
            {
